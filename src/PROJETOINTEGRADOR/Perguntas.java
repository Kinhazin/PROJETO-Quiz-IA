...
public class Perguntas {
    ...
    public static int[][] PrimeiraPegunta(int parametros[][]) {
        int auxiliares[] = new int[3]; // 1º Para enviar qual pergunta é, 2º Variavel de controle de laço, 3º para saber se a resposta está certa ou errada            
        char alternativa;
        auxiliares[0] = 1;
    ...
    public static int[][] terceiraPegunta(int parametros[][]) {
        ...
        System.out.println("Tendo em mente como surgiu a ideia da inteligência artificial, devemos falar do primeiro evento relacionado a IA,\n"
    ...
    public static int[][] quartaPegunta(int parametros[][]) {
        ...
        System.out.println("A conferência de Dartmouth certamente foi de extrema importância para o desenvolvimento da IA, tanto que,\n"
